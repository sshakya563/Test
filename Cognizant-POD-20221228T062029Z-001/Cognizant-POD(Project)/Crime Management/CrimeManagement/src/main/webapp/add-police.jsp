    ...
    <div class="container" style="width: 110vh; background-color: ghostwhite; margin-top:40px;">
        ...
        <form method="post" action="InsertController">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="stationId" name="station-Id" placeholder="Enter Station ID" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="address" class="col-sm-3 col-form-label">Address:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address" name="station-address" placeholder="Enter Station Address" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="pinCode" class="col-sm-3 col-form-label">Pin Code:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="pinCode" name="station-pinCode" placeholder="Enter Pin Code" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="address" class="col-sm-3 col-form-label">SHO Name:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="shoName" name="station-shoName" placeholder="Enter SHO Name" required>
                </div>
            </div>

            <center>
                <button type="submit" id="submit" class="btn btn-success">Add Details</button>
                <br><br>
