	...
	<!-------------------------------- Navigation Bar --------------------------------------->
		<div
			...
			<a href="html/missingpersons.jsp" style="width: 15.43vw;">MISSING
				...
				style="width: 17.38vw;">UNIDENTIFIED BODIES</a> 
				<a href="html/crimetypes.jsp" style="width: 12.83vw;">CRIME TYPES</a>
			    <form id="logout" action="LogOutController"></form>
				<a onclick='return logout()' style="width:13.83vw;cursor: pointer;">LOGOUT</button>
...
<div class="container" style="width: 110vh; background-color: ghostwhite; margin-top:10px;">
	...
	<br>
	<form method="post" action="complaintStatusApproval" >
    ...
    <div class="col-sm-9">
      <input type="text" readonly class="form-control" id="email" value="<%= (String) session.getAttribute("email") %>">
    </div>
  </div>
  <div class="form-group row">
