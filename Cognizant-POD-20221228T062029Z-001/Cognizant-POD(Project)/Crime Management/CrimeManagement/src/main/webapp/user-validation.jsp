...
%>
<h2 align="left" style="position:relative; margin-left:40px; margin-bottom:0px;"><strong>User Records</strong></h2>
<hr style="border: 1px solid black; width:300px; margin: 6px auto 6px 40px;"><br>
<table align="center" width="900px" cellspacing="0" cellpadding="0" border="0" style="position:absolute; margin-left:40px;">
       <tr>
       <td>
