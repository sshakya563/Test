...
<div class="container" style="width: 110vh; background-color: ghostwhite; margin-top:6px;">
	<h3
	...
	<br>
        ...
        <ul class="list-group">
            ...
            <li style="height: 8vh;" class="list-group-item">Additional Information - <%= (String) session.getAttribute("additionalInfo") %> </li>
            <li class="list-group-item">Last Updated On - <%= (String) session.getAttribute("last_update_time") %></li>
          </ul>
    <center>
    <button onclick='window.location.replace("track-complaint.jsp")' type="button" id="submit"
